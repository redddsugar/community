...
import com.ln.community.util.RedisKeyUtil;
...
public class FollowService implements CommunityConstant {
    ...
    //查询某用户关注的人  list = [map1("user":XX,"followTime":XX),map2("user":XX,"followTime":XX)...]
    ...
    //查询某用户的粉丝      list = [map1("user":XX,"followTime":XX),map2("user":XX,"followTime":XX)...]
